...
Download and prepare the dataset in YOLO format. Tools such as [**Roboflow**](https://app.roboflow.com/) are highly recommended if you want to prepare your own fire dataset. The generated dataset should contain a YAML file, for example, `train_data.yaml`.
