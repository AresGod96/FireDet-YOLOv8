...
In [`cpp/YOLOv8/YOLOv8/main.cpp`](cpp/YOLOv8/YOLOv8/main.cpp), modify the engine path in line 30 [`const std::string engine_file_path`] and everything shall be ready to go.
